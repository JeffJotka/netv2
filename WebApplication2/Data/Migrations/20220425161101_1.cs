        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserViewModel_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserViewModel_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Appointments_UserViewModel_UserViewModelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_UserViewModelId",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserViewModel_DoctorId",
                table: "UserViewModel",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_UserViewModel_PatientId",
                table: "UserViewModel",
                column: "PatientId");
        }
